...
public class DatabaseConnDialog extends JDialog {
    ...
    public DatabaseConnDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MessageLabel.setText("Database Server not Found!");
        jPanel1.add(MessageLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, -1, -1));
