...
public class PassStaffWrongDialog extends JDialog {

    public PassStaffWrongDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MessageLabel.setText("Incorrect Staff ID and Password!");
