...
public class InvalidDialog extends JDialog {

    public InvalidDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MessageLabel.setText("Invalid Data Entered!");
        jPanel1.add(MessageLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, -1, -1));
