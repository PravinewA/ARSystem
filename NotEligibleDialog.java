...
public class NotEligibleDialog extends JDialog {

	public NotEligibleDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
	...
	private void initComponents() {
        ...
        MessageLabel.setText("You are not eligible for Driving");
    ...
    public static void main(String args[]) {
    	java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NotEligibleDialog dialog = new NotEligibleDialog(new JFrame(), true);
