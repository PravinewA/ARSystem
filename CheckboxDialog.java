...
public class CheckboxDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        MessageLabel.setText("Please fill all the fields and tick Checkbox");
        jPanel1.add(MessageLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));
    ...
    public static void main(String args[]) {
    	java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CheckboxDialog dialog = new CheckboxDialog(new JFrame(), true);
