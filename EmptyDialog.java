...
public class EmptyDialog extends JDialog {
    ...
    public EmptyDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MessageLabel.setForeground(new java.awt.Color(255, 255, 255));
        	MessageLabel.setText("Field cannot be left Empty");
        jPanel1.add(MessageLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, -1, -1));
