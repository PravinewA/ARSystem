...
public class DoubleVNDialog extends JDialog {

	public DoubleVNDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MessageLabel.setText("Vehicle Number is already used");
