...
public class PassAdminWrongDialog extends JDialog {

    public PassAdminWrongDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MessageLabel.setText("Incorrect Admin ID and Password!");
